        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-end">
            <button
              ...
              disabled={saving}
              className="inline-flex items-center justify-center px-4 py-2 font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 bg-green-600 text-white hover:bg-green-700 shadow-lg shadow-emerald-700/30 disabled:opacity-50 disabled:cursor-not-allowed gap-2"
            >
  ...
  >
    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
      ...
      {user?.subscription.plan === "free" && (
        <Link
          to="/plans"
          className="inline-flex items-center justify-center px-4 py-2 font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 bg-green-600 text-white hover:bg-green-700 shadow-lg shadow-emerald-700/30"
        >
          Upgrade to Pro
        </Link>
      )}
